...
type ViewForm struct {
	...
	-- если вставить условные операторы в шаблон, то можно обойтись без булевых переменных.
В этом случае в шаблон достаточно передавать  Paragraph (без преобразования в другую структуру)
